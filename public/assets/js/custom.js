! function(e, s, i) {
    ...
    $('.navbar .dropdown.notification-dropdown > .dropdown-menu, .navbar .dropdown.message-dropdown > .dropdown-menu ').on('click', function(e){
        e.stopPropagation();
    })
    /* Tooltips */
    $('.bs-tooltip').tooltip();
    ...
    $('.nav-item .dropdown-menu .nav-drop-body a.account-item.settings').on('click', function(){
