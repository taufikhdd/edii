    ...
    var App = function() {
        ...
        var inBuiltfunctionality = {
            ...
            preventScrollBody: function() {
                ...
                $('.rightbar-tab-container').on('mousewheel DOMMouseScroll', function(e) {
                    var scrollTo = null;
                    if (e.type == 'mousewheel') {
                        scrollTo = (e.originalEvent.wheelDelta * -1);
                    }
        ...
        //header.blade.php: Uncomment below function to use Switch option
        /*var nightLightMode = {
            nightLight: function () {
                ...
                function checkTheme() {
                    ...
                    if (localStorageTheme !== null && localStorageTheme === "darkmode") {
