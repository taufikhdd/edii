                    ...
                    <div class="card multiple-form-one px-0 pb-0 mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-12 mx-0">
                                <form id="msform" action="{{ route('lapmingguans.store') }}" method="POST">
                                    @csrf
                                    {{ Form::hidden('instansi_id', $instansi_id) }}
                                    ...
                                    <fieldset>
                                        <div class="form-card">
                                            <h5 class="fs-title mb-4">Input Biodata</h5>
                                                    ...
                                                    <div class="row" style="margin-top: 14px">
                                                        ...
                                                        <div class="col-md-12">
                                                            <input type="number" placeholder="No. KTP" maxlength="16"
                                                                name="ktp" class="form-control mb-3" />
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row" style="margin-top: 14px">
                                                        ...
                                                        <div class="col-md-12">
                                                            <input type="text" placeholder="Tempat Lahir"
                                                                name="tpt_lahir" class="form-control mb-3" />
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row" style="margin-top: 14px">
                                                        ...
                                                        <div class="col-md-12">
                                                            <input type="date" placeholder="Ada di SIAK"
                                                                name="tgl_lahir" class="form-control mb-3" />
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row" style="margin-top: 14px">
                                                        ...
                                                        <div class="col-md-12">
                                                            <input type="text" placeholder="Alamat KTP"
                                                                name="alamat_ktp" class="form-control mb-3" />
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row" style="margin-top: 14px">
                                                        ...
                                                        <div class="col-md-12">
                                                            <input type="text" placeholder="Alamat Tinggal Saat Ini"
                                                                name="alamat_tgl" class="form-control mb-3" />
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row" style="margin-top: 14px">
                                                        ...
                                                        <div class="col-md-12">
                                                            <input type="number"
                                                                ...
                                                                name="org_terdekat" class="form-control mb-3" />
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row" style="margin-top: 14px">
                                                        ...
                                                        <div class="col-md-12">
                                                            <input type="text"
                                                                ...
                                                                name="skill" class="form-control mb-3" />
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row" style="margin-top: 14px">
                                                        ...
                                                        <div class="col-md-12">
                                                            <input type="number" placeholder="Penghasilan perbulan"
                                                                name="penghasilan" class="form-control mb-3" />
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <fieldset>
                                        <div class="form-card">
                                            <h5 class="fs-title mb-4">Input Pendidikan Terakhir</h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" name="addPendidikan[0][nama_pend]"
                                                                placeholder="Nama Institusi" class="form-control" />
                                                        </td>
                                                        <td>
                                                            <input type="text"
                                                        ...
                                                        <td>
                                                            <input type="text" name="addPendidikan[0][ipk_pend]"
                                                                placeholder="IPK" class="form-control" />
                                                        </td>
                                    ...
                                    <fieldset>
                                        <div class="form-card">
                                            <h5 class="fs-title mb-4">Input Riwayat Pelatihan</h5>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text" name="addPelatihan[0][nama_pelatihan]"
                                                                placeholder="Nama Kursus/Seminar" class="form-control" />
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <input type="number"
                                                                ...
                                                                placeholder="Tahun Pelatihan" class="form-control" />
                                                        </td>
                                    ...
                                    <fieldset>
                                        <div class="form-card">
                                            <h5 class="fs-title mb-4">Input Riwayat Pekerjaan</h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" name="addPekerjaan[0][posisi_pekerjaan]"
                                                                placeholder="Posisi Terakhir" class="form-control" />
                                                            </select>
                                                        </td>
                                                        <td>
                                                            <input type="number"
                                                                name="addPekerjaan[0][pendapatan_pekerjaan]"
                                                                placeholder="Pendapatan Terakhir" class="form-control" />
                                                        </td>
                                                        <td>
                                                            <input type="number"
                                                                name="addPekerjaan[0][tahun_pekerjaan]"
                                                                placeholder="Tahun Terakhir" class="form-control" />
                                                        </td>
